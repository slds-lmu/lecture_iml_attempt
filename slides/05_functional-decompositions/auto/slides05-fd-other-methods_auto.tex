...
\end{itemize}
    ...
    % \textbf{N.B.:} For dependent inputs, % OLD
%\citebutton{Hooker (2007)}{http://www.tandfonline.com/doi/abs/10.1198/106186007X237892}
% new
\furtherreading{Hooker_2007} showed the existence of a unique solution for the components under a ``relaxed vanishing condition'' which leads to a ``hierarchical orthogonality''
