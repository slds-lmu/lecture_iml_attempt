...
\begin{itemize}
 ...
 $\leadsto$ Shape of ICE curves changes across different (higher) values of other feature% %(esp. for high values)%at different horizontal and vertical slices varies 
  \begin{itemize}
