...
A related presentation can be found in \furtherreading{Adadi_Berrada}.
...
\medskip
\textbf{Example:} Neural Net Tank (gwern.net)\sourceref{https://www.gwern.net/Tanks} \\
	\centering
    % splitVCC / splitVTT worked badly here
    \begin{columns}[T, totalwidth = \textwidth]
	\begin{column}{0.4\textwidth}
	\centering
...
$\leadsto$ Insights help to identify flaws (in data or model), which can be corrected \\[2ex]
    ...
    % we have one hanging word here, I didn't try to fix it since this is a quote
    \begin{quote}
    ...
    \end{quote}
    (Thomas G. Dietterich) \sourceref{https://x.com/tdietterich/status/1154839042623594496}
 \end{frame}
...
\begin{frame}{Justification and fairness: COMPAS~\furtherreading{Larson}}
    $\leadsto$ Investigate if and why biased, unexpected or discriminatory predictions were made \\
    \medskip
...
\begin{frame}{Justification and fairness: COMPAS \furtherreading{Alvarez_Melis_Jaakkola}}
...
\medskip
    ...
    \begin{itemize}
        ...
        "XAI Stories" \sourceref{https://pbiecek.github.io/xai_stories/story-compas.html\#model-specific}\\
