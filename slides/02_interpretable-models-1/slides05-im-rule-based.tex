...
\begin{frame}{Decision Trees \furtherreading{Breiman}}
...
\vspace{-0.2cm}
\furtherreading{Hothorn}
\furtherreading{Zeileis}
\furtherreading{Strobl}
...
\begin{columns}[c, totalwidth=\textwidth]
    \begin{column}{0.6\textwidth}
        \textbf{Decision Rules} \furtherreading{Holte}
        \begin{itemize}
...
\begin{columns}[c, totalwidth=\textwidth]
    \begin{column}{0.65\textwidth}
        ...
        % \end{itemize}
        \textbf{RuleFit} \furtherreading{Friedman_Popescu}
\begin{itemize}
